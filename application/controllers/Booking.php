...
class Booking extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $user = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])
        ->row_array();
        foreach ($user as $a) {
            $data = [
                'image' => $user['image'],
    ...
    public function tambahBooking()
    {
        ...
        //memilih data buku yang untuk dimasukkan ke tabel temp/keranjang memalui variabel $isi
        ...
        if ($databooking > 0) {
            ...
            message" role="alert">Masih ada booking buku sebelumnya yang belum diambil.<br>
        ...
        if ($temp > 0) {
            $this->session->set_flashdata('pesan', '<div class="alert alert-danger alert-massage"
        ...
        $this->session->set_flashdata('pesan', '<div class="alert alert-succes alert-message"
    ...
    public function hapusbooking()
    {
        ...
        if ($kosong < 1) {
            $this->session->set_flashdata('pesan', '<div class="alert alert-massage alert-danger"
